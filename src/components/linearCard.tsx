...
// import preview from '/vercel.svg';
import {
  Dialog,
  DialogTrigger,
  DialogContent,
          ...
          <>
            ...
            >
              <DialogTrigger
                ...
                className='flex w-full flex-col overflow-hidden  border   bg-slate-700 hover:bg-slate-800'
              >
                <DialogImage
                  src={item.url}
                  alt='Card Image'
                ...
                <div className='flex flex-grow flex-row items-end justify-between p-3'>
                  ...
                  {/* <button className='absolute bottom-2 right-2 p-2 bg-slate-800 hover:bg-gray-500 rounded-full '>
                    <Eye className='w-6 h-6 text-slate-200' />
                  </button> */}
                  <div className='w-8 h-8 rounded-full overflow-hidden relative'>
                    <Image src={'/me.jpg'} fill={true} alt='Modal picture' />
                  </div>
                </div>
              </DialogTrigger>
